...
public enum EnumConfigProperty {
    ...
    LESS_POP_MC_NB("input.value.less_popular_mc_number"),
    HUGE_SALLE_NB("input.value.huge_salles_mc_number"),
    MIN_PART_NB_MC("input.value.min_part_number_for_mc"),
    MIN_FULL_FACTOR("input.value.min_full_factor"),
    MAX_FULL_FACTOR("input.value.max_full_factor"),
